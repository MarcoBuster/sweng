...
Un altro esempio più tecnico è GitFlow che ci permette tramite dei semplici comandi come _init_, _feature start/finish_ oppure _release_, di compiere molte più operazioni insieme, come la creazione di branch, lo switching e il merge.
