...
## <big>M</big>ODEL <big>V</big>IEW <big>C</big>ONTROLLER

<!-- da aggiungere l'intro -->

### MVC vs MVP

<!-- ... -->

Inoltre, testare l'interfaccia grafica è spesso difficile. 
Il modello <big>M</big>ODEL <big>V</big>IEW <big>P</big>RESENTER aiuta a risolvere questo problema.
È quindi possibile pestare il _presenter_ tagliando fuori la vista e mockando il modello. 

## <big>B</big>UILDER (ALTERNATIVE)

Il pattern builder lascia la possibilità di rendere opzionali più parametri del costruttori, anche se dello stesso tipo.
