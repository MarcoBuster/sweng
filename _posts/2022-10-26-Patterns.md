...
{% responsive_image path: assets/09_nullObject.png %}
...
{% responsive_image path: assets/09_pairwise-dependencies.png %}
...
{% responsive_image path: assets/09_observer.png %}
...
{% responsive_image path: assets/09_Class-adapter.png %}
...
Potremmo fare un qualcosa di diverso, modificando lo schema UML, potremmo modificare la freccia di ereditarietà tra ClassAdapter e Adaptee e farla diventare una freccia di composizione, rispettando ciò che abbiao detto molte volte, ovvero prediligere la composizione rispetto all'ereditarietà, in modo da portare fuori un'aspetto dalla classe e poi da li sarà comunque possibile avere una gerarchia.
...
{% responsive_image path: assets/09_Object-adapter.png %}
