...
* **Tra use case**: la semantica è simile all'*extend*, ma senza punti d'estensione. <br> Invece, alcune parti della descrizione vengono *ereditate* e altre vengono *sostituite*. Non segue il secondo principio della Liskov.
